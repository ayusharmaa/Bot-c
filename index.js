...
async function startXeonBotInc() {
    ...
    XeonBotInc.ev.on('connection.update', async (s) => {
        ...
        if (connection == "open") {
            ...
            console.log(chalk.magenta(`\n${global.themeemoji || '•'} YT CHANNEL: Nhi Hai`))
            console.log(chalk.magenta(`${global.themeemoji || '•'} GITHUB: kya karega jaan kar`))
            console.log(chalk.magenta(`${global.themeemoji || '•'} WA NUMBER: ${owner}`))
            console.log(chalk.magenta(`${global.themeemoji || '•'} CREDIT: Anuj`))
